...
float serie () {
  int coracao; for (coracao = 0; coracao < j; coracao++) {system("cls"); printf("\n   ..      ..   "); delay(h); printf("\n  .....   ..... "); delay(h); printf("\n ..............."); delay(h); printf("\n ..............."); delay(h);
  printf("\n  ............."); delay(h); printf("\n   ..........."); delay(h); printf("\n    ........."); delay(h); printf("\n     ......."); delay(h);
  printf("\n      ....."); delay(h); printf("\n       ..."); delay(h); printf("\n        ."); delay(h); system("cls");} h = 100; j = 2; return(1);
}
int main () {
  ...
  int f; for (f = 0; f < 196; f++) printf("%c", frases[f]), delay(100); delay(3000);
  int ch; do {
    ...
    int f; for (f = 0; f < 249; f++) printf("%c", frases[f]), delay(45); scanf("%d",&ch); fflush(stdin);
    if (ch == 1) {
      ...
      int f; for (f = 0; f < 1292; f++) printf("%c", frases[f]), delay(65); getch();
    }
  ...
  if (ch == 2) {
    ...
    for (f = 0; f < 50; f++) printf("%c", frase[f]), delay(100); delay(2000);
    char ch1 = '1'; do {
     serie(); char frases[] = "\n\n DESAFIO 1: Qual eh o seu nome (preciso confirmar que eh voce):\n\n (a)- Aninha. \n\n"
     " (b)- Xuxu.\n\n (c)- Ana Clara Scomparim Oliveira.\n\n (d)- Pudinzinho.\n\n (e)- Isso nao importa, apenas te amo.\n\n\n Resposta:  ";
     int f; for (f = 0; f < 203; f++) printf("%c", frases[f]), delay(20); scanf("%c",&ch1); fflush(stdin);
     if (ch1 != 'd') serie(), printf("\n\n\n\n  ERROU!! Estou em duvida se voce eh mesmo o meu love... to de olho."), delay(4000);
    }
    while (ch1 != 'd');
    serie(); printf("\n\n\n\n  ACERTOU!! Logico que seu nome importa, ele eh pudinzinho!"); delay(4000);
     ch1 = '1'; do {
     ...
     int f; for (f = 0; f < 234; f++) printf("%c", frases[f]), delay(20); scanf("%c",&ch1); fflush(stdin);
     if (ch1 != 'c') serie(), printf("\n\n\n\n  ERROU AMORZINHO, que decpcao..."), delay(4000);
    }
    while (ch1 != 'c');
    serie(); printf("\n\n\n\n ACERTOUU VIDAA! Tu eh um bebe, porem tem um corpao da poha..."); delay(4000);
     ch1 = '1'; do {
     ...
     int f; for (f = 0; f < 225; f++) printf("%c", frases[f]), delay(20); scanf("%c",&ch1); fflush(stdin);
     if (ch1 != 'd' && ch1 != 'a') serie(), printf("\n\n\n\n  ERROU CARALHO!!"), delay(4000);
     else if (ch1 == 'a') serie(), printf("\n\n\n\n  Essa poderia ser bb safada :), mas errou..."), delay(4000);
    }
    while (ch1 != 'd');
    serie(); printf("\n\n\n\n  ACERTOUU VIDAA! Voce prefere mais Hamburguer sim, sei mais que voce..."); delay(4000);
     ch1 = '1'; do {
     ...
     int f; for (f = 0; f < 210; f++) printf("%c", frases[f]), delay(20); scanf("%c",&ch1); fflush(stdin);
     if (ch1 != 'a') serie(), printf("\n\n\n\n  IMPOSSIVEL VOCE ERRAR ESSA PO!"), delay(4000);
    }
    while (ch1 != 'a');
    serie(); printf("\n\n\n\n  ACERTOUU VIDAA! Tudo meu eh seu..."); delay(4000);
     ch1 = '1'; do {
    ...
    serie(); printf("\n\n\n\n  Todas estavam certas vida HAHAHA!!"); delay(4000);
    serie(); char frase1[] = "\n\n  ETAPA 2: CHARADAS - DIFICULDADE: ATE QUE VAI.";
    for (f = 0; f < 49; f++) printf("%c", frase1[f]), delay(100); delay(3000);
    ch = 0; do {
      ...
      int f; for (f = 0; f < 91; f++) printf("%c", frases[f]), delay(30);
      fgets(deposito, sizeof(deposito), stdin);
      sscanf(deposito, "%s", &senha2); fflush(stdin); if (strcmp (senha1,senha2) == 0 ) ch = 1;
      if (ch == 0) serie(), printf("\n\n  ERROU! NAO ACREDITO QUE ERRARIA ISSO..."), delay(3000); }
    while (ch == 0); serie(); printf("\n\n  ACERTOU! CLARO QUE EH AQUELE GORDINHO SAFADO."), delay(3000);
    ch = 0; do {
      ...
      int f; for (f = 0; f < 156; f++) printf("%c", frases[f]), delay(30);
      fgets(deposito, sizeof(deposito), stdin);
      sscanf(deposito, "%s", &senha2); if (strcmp (senha1,senha2) == 0 ) ch = 1; fflush(stdin);
      if (ch == 0) serie(), printf("\n\n  TEM CERTEZA QUE EU PEDIRIA ISSO NA SUA PADARIA?"), delay(3000); }
    while (ch == 0); serie(); printf("\n\n  ACERTOU!!! E APROVEITA E ME DA UM BOLINHO COM DONUTS?"), delay(5000);
    ch = 0; do {
      serie(); char senha1[21] = "acefalinho",senha2[21],deposito[26];
      char frases[] = "\n\n  DESAFIO 8: Com voce ate a malformacao da mula sem cabeca virou um\n     elogio carinhoso.\n\n\n  Resposta: ";
      int f; for (f = 0; f < 107; f++) printf("%c", frases[f]), delay(30);
      fgets(deposito, sizeof(deposito), stdin);
      sscanf(deposito, "%s", &senha2); fflush(stdin); if (strcmp (senha1,senha2) == 0 ) ch = 1;
      if (ch == 0) serie(), printf("\n\n  ERROU! SABIA QUE VOCE ERA..."), delay(3000); }
    while (ch == 0); serie(); printf("\n\n  PARABENS ACEFALINHA, VOCE PEGOU O JEITO!"), delay(4000);
    ch = 0; do {
      ...
      int f; for (f = 0; f < 100; f++) printf("%c", frases[f]), delay(30);
      fgets(deposito, sizeof(deposito), stdin);
      sscanf(deposito, "%s", &senha2); if (strcmp (senha1,senha2) == 0 ) ch = 1; fflush(stdin);
      if (ch == 0) serie(), printf("\n\n MDS PERDEDORA, TENTA DE NOVO!"), delay(3000); }
    while (ch == 0); serie(); printf("\n\n SO NAO VAI PEDIR TRUCO EM MAO DE ONZE AGORA HEIN!"), delay(3000);
    serie(); char frase2[] = "\n\n  ETAPA 3: CHARADAS - DIFICULDADE: DE PISCAR O CU.";
    for (f = 0; f < 53; f++) printf("%c", frase2[f]), delay(100); delay(5000);
    ch = 0; do {
